...
def ResNetFusion18(in_channels, num_classes=2):
    return ResNetFusion(block, [2, 2, 2, 2], in_channels, num_classes)


def ResNetFusion50(in_channels=3, num_classes=2):
    return ResNetFusion(block, [3, 4, 6, 3], in_channels, num_classes)
